...
public class PessoaAlterarTela extends javax.swing.JFrame {
    ...
    private void carregarCampos(){
        ...
        if(p.getSexo() == 'M'){
            botaoRadioMasc.setSelected(true);
        } else if (p.getSexo() == 'F'){
            botaoRadioFem.setSelected(true);
        }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Alterar Usuário");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PessoaAlterarTela.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
